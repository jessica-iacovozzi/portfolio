...
export default function Button({ link, text, target }: ButtonProps): JSX.Element {
  return (
    <a 
      ...
      className="w-fit text-lg relative inline-flex border-2 mt-10 border-white hover:border-gray-950 justify-center px-6 py-3 overflow-hidden font-medium transition-all bg-gray-950 rounded-lg hover:bg-gray-950 group min-h-[44px] min-w-[120px] items-center active:scale-95 touch-manipulation"
